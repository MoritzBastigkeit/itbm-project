...
\section{Data Loading and Preparation}\label{data-loading-and-preparation}
...
\subsection{Loading external data}\label{loading-external-data}
...
\textbf(status.of.existing.checking.account) (categorical)
This is a categorical variable that describes the applicant's checking account condition using qualitative labels such as ``no checking account'', ``\textless0 DM'', etc.
...
\textbf(credit.history) (categorical)
...
\textbf(savings.account.and.bonds) (categorical)
This is another variable that categorises the applicant's savings level, both in their savings account and bonds. There are several categories such as ``unknown/no savings account'' to '' \textless{} 100 DM'' to separate those into groups.

\textbf(purpose) (categorical)
...
\caption{\label{tab:testTable}Exemplary View of the Data Table}
\centering
...
\caption{\label{tab:unnamed-chunk-4}Information Value of Predictor Variables}
\centering
\begin{tabular}[t]{l|c}
\hline
...
\subsection{Filtering and Splitting Data}\label{filtering-and-splitting-data}

In the following step, the data is filtered to exclude rows with missing values and split into train and validation set. The split chosen is at a ratio of .75 to .25. This is being done to have two independent samples for training and validating the model at a later point.
...
\begin{verbatim}
## List of 2
##  $ train   : int [1:727] 0 0 1 0 0 0 1 1 0 1 ...
##  $ validate: int [1:273] 1 0 0 1 0 1 1 0 0 1 ...
\end{verbatim}
...
\begin{verbatim}
## v Binning on 727 rows and 6 columns in 00:00:10
\end{verbatim}
...
\begin{center}\includegraphics{Scorecard_Intro_2511_files/figure-latex/unnamed-chunk-11-1} \end{center}
...
\begin{center}\includegraphics{Scorecard_Intro_2511_files/figure-latex/unnamed-chunk-12-1} \end{center}
...
\begin{center}\includegraphics{Scorecard_Intro_2511_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\begin{center}\includegraphics{Scorecard_Intro_2511_files/figure-latex/unnamed-chunk-14-1} \end{center}
...
\begin{verbatim}
## v Woe transformating on 727 rows and 5 columns in 00:00:10
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{Scorecard_Intro_2511_files/figure-latex/unnamed-chunk-45-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Scorecard_Intro_2511_files/figure-latex/unnamed-chunk-48-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Scorecard_Intro_2511_files/figure-latex/unnamed-chunk-53-1.pdf}}
