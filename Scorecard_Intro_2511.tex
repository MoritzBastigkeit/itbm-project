...
\subsubsection{status.of.existing.checking.account (categorical)}\label{status.of.existing.checking.account-categorical}
...
\subsubsection{duration.in.month (numeric)}\label{duration.in.month-numeric}
...
\subsubsection{credit.history (categorical)}\label{credit.history-categorical}
...
\subsubsection{savings.account.and.bonds (categorical)}\label{savings.account.and.bonds-categorical}
...
\subsubsection{purpose (categorical)}\label{purpose-categorical}
...
\begin{center}\includegraphics{Scorecard_Intro_2511_files/figure-latex/unnamed-chunk-16-1} \end{center}
...
\begin{verbatim}
## v Woe transformating on 635 rows and 5 columns in 00:00:10
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{Scorecard_Intro_2511_files/figure-latex/unnamed-chunk-51-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Scorecard_Intro_2511_files/figure-latex/unnamed-chunk-54-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{Scorecard_Intro_2511_files/figure-latex/unnamed-chunk-59-1.pdf}}
